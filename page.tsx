...
export default function SiteInspector() {
  ...
  const extractInlinedHTML = async () => {
    ...
    try {
      ...
      // ── 1. Identifier les éléments visibles dans le viewport étendu (3x hauteur) ──
      ...
      allOrig.forEach((el) => {
        ...
        // Garder tout ce qui est dans les 3 premières hauteurs de page
        if (rect.bottom < -100 || rect.top > vpH * 3) return
      ...
      // ── 5. Construire le document final ──────────────────────────────────
