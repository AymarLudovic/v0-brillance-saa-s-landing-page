...
export const DESIGN_SYSTEM_V12 = `# 


Celle-ci (cette Sidebar de pages d'applications):
...
Tu dois absolument combiné le même principe de ces instructions suivantes, avec les images quk te sont envoyées, tu dois en fait comprendre que ces instructions ici dessous montre absolument le niveau level de design que l'on s'attend que tu fasses pour des Landing pages et tu va additioner avec ça ton ultra analyse des images de contexte que tu reçois et t'assurer toujours de tout faire et bien.
