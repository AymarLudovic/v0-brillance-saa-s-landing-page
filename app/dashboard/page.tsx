  ...
  return (
    <div className="bg-white border border-gray-200 rounded-2xl p-5 hover:shadow-md hover:border-gray-300 transition-all">
      <div className="flex items-start justify-between gap-3 mb-4">
        ...
        <span className="text-[10px] font-mono bg-gray-100 text-gray-500 px-2 py-1 rounded-lg shrink-0 border border-gray-200">
          {site.siteId}
        </span>
      </div>
...
export default function DashboardIndex() {
  ...
  // ── Sign in ────────────────────────────────────────────────────────────────
  if (!user) return (
    <div className={`${jakarta.className} min-h-screen bg-white flex flex-col`}>
      {/* minimal nav */}
      <div className="border-b border-gray-100 px-6 py-4">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-gray-900">Poyne</span>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4">
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            <div className="w-16 h-16 bg-gray-900 rounded-2xl flex items-center justify-center mx-auto mb-5 shadow-xl">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2">
                <path d="M18 20V10M12 20V4M6 20v-6"/>
              </svg>
            </div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Poyne Analytics</h1>
