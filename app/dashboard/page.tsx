    ...
    <div className="bg-transparent border-[#b0b0b0] p-2 hover:shadow-md hover:border-gray-300 transition-all">
      <div className="flex items-start justify-between gap-3 mb-4">
        ...
        <a href={`/dashboard/${site.siteId}`}
          className="flex items-center gap-1.5 underline-dashed  px-3 py-1.5 bg-gray-900 text-[#171717] rounded-lg text-xs font-medium hover:bg-gray-700 transition-colors">
