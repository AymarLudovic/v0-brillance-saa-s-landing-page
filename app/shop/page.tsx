    ...
    try {
      ...
      if (decision.route === 'html_js' || decision.route === 'html_nextjs') {
        ...
        if (decision.route === 'html_js') {
          ...
          const newJs2 = await callGeminiFeatures(apiKey, imgB64, imgMime, enrichedHtml, newJs1, progress);
          ...
          const allFiles = await callGeminiNextJS(apiKey, imgB64, imgMime, enrichedHtml, newJs1, enrichedWithJs, progress);
