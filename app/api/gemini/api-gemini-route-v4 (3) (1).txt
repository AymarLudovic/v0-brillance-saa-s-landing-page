...
IMPORTS — RÈGLES ABSOLUES :
  Utilise TOUJOURS les alias @/ pour les imports internes :
    import { cn } from "@/lib/utils"          ← CORRECT
    import { cn } from "../lib/utils"          ← INTERDIT
    import { cn } from "../../lib/utils"       ← INTERDIT
  Un identifiant ne peut être importé QU'UNE SEULE FOIS dans un fichier.
  Si cn est déjà importé via { cn } → ne l'importe plus nulle part ailleurs.
  Si tu utilises cn() dans un fichier → importe depuis "@/lib/utils" une seule fois.
