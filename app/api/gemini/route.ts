...
• Le texte des menus doit toujours avoir un bon font bold, généralement font-semibold, et une taille moyenne, c'est-à-dire ni trop grand ni trop petit.

• Les éléments dans ce type de navbar doivent toujours être bien alignés et bien agencés afin qu'aucun élément ne soit décalé par rapport à l'autre.

• La hauteur de la navbar ne doit jamais être trop grande. 50px est le maximum.
