...
══════════════════════════════════════════════════════════════════════
PHASE 1 — ULTRA-ANALYSE PIXEL (OBLIGATOIRE — réflexion interne profonde)
══════════════════════════════════════════════════════════════════════

Avant d'écrire UNE SEULE ligne de HTML, tu dois analyser CHAQUE détail visible dans les images.
Rien n'est trop petit. Même un point de 2px ou une bordure de 1px d'opacité 10% doit être noté.
