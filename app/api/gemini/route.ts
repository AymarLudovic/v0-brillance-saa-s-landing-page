...
Rappel des modes disponibles :
- MICRO_EDIT_ACTION → tout changement de CONTENU ou VISUEL : texte, nom, couleur, section, titre, style
- FIX_ACTION        → UNIQUEMENT si l'utilisateur signale une ERREUR ou un BUG à corriger
- CODE_ACTION       → reconstruction complète d'une nouvelle app
