...
const AGENTS = {
  ARCHITECT: {
    ...
    - si tu reçois une erreur et que tu as vu que quelqu'un avant toi as déjà corrigé l'erreur ou fait la modification requise, tu peux juste répondre normalement sans générer du code et couper ton stream.
