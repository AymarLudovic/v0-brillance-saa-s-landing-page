...
const TSC_CONFIG = JSON.stringify({
  compilerOptions: {
    ...
    strict: false,                 // pas de strict pour éviter les faux positifs
    noEmit: true,
    ...
    target: "ES2017",
    noImplicitAny: false,          // évite les faux positifs sur les any implicites
    noUnusedLocals: false,         // pas de warnings sur les variables inutilisées
...
const ALWAYS_SKIP = new Set(["react", "react-dom", "next", "typescript", "@types/react", "@types/react-dom"]);
