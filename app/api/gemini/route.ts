...
⚠️ JAMAIS create_file pour un fichier déjà existant — toujours edit_file.
⚠️ JAMAIS omettre le "---" avant un create_file.
...
FORMAT DE SORTIE :
CRÉER un nouveau fichier — ligne "---" seule AVANT, puis :
---
<create_file path="chemin/fichier.tsx">
contenu complet
</create_file>

MODIFIER un fichier existant — edit_file uniquement :
<edit_file path="chemin/fichier.tsx" action="replace">
<start_line>N</start_line>
<end_line>M</end_line>
<changes_to_apply>contenu corrigé</changes_to_apply>
</edit_file>

À la fin si nécessaire :
DEPENDENCIES: ["package"]  ← nouveau package npm ajouté
`;
