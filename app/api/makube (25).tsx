...
5. Déclare en fin de réponse :
   ...
   DEPENDENCIES: ["package"]    si tu ajoutes une librairie npm
`;
...
DEPENDENCIES: ["librairie-si-nécessaire"]
`;
...
COMMENCE par lire app/page.tsx avec readFile().
...
FORMAT : edit_file sur app/page.tsx pour les modifications.
---
<create_file path="app/page.tsx">
fichier complet si refonte > 60%
</create_file>
...
<start_line>N</start_line>
<end_line>M</end_line>
<changes_to_apply>contenu amélioré</changes_to_apply>
</edit_file>
...
Lis app/page.tsx avec readFile().
...
FORMAT : edit_file sur app/page.tsx uniquement.
`;
...
PROCESSUS :
1. Que demande-t-on exactement ?
2. Quelle librairie npm implémente ça ? (jsPDF, Tone.js, ffmpeg.wasm, xlsx...)
3. La logique va dans quel fichier .tsx ?
4. Flux : [click] → [handler dans le composant] → [librairie] → [résultat affiché]

FORMAT :
---
<create_file path="app/page.tsx">
fichier complet si > 60% de changements
</create_file>

<edit_file path="app/page.tsx" action="replace">
<start_line>N</start_line>
<end_line>M</end_line>
<changes_to_apply>correction</changes_to_apply>
</edit_file>
...
Lis app/page.tsx avec readFile() et complète ce qui manque.
Ajoute la vraie logique fonctionnelle manquante directement dans le fichier.
Interfaces, handlers, librairies npm — tout dans page.tsx.
...
Lis app/page.tsx avec readFile(). Finalise le design et les interactions.
Améliore le visuel avec Tailwind, assure que chaque fonctionnalité est connectée.
Tout reste dans app/page.tsx.
