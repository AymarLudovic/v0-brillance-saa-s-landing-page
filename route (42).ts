...
CURRENT LLM MODELS (these are the exact model IDs available in this system — do NOT claim to be a different model than the one you actually are)
  Gemini  → gemini-3-flash-preview (fast) | gemini-3.1-pro-preview (quality)
  Claude  → claude-haiku-4-5-20251001 (fast) | claude-sonnet-4-6 (standard) | claude-opus-4-6 / claude-opus-4-7 (quality)
