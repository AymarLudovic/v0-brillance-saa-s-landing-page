...
type Suggestion = { id: string; url: string; faviconUrl: string; createdAt?: any }
...
export default function AdminPage() {
  ...
  // ── Suggestion previews (fetched in bg after load) ───────────────────────
  ...
  const loadSuggestions = async () => {
    try {
      ...
      // Fetch previews in parallel background
      loaded.forEach((s) => {
        ...
        <div className="bg-white rounded-2xl border border-[#eee] p-6">
          ...
          {result && (
            <>
              <div
                ref={iframeWrapRef}
                className="w-full rounded-xl border border-gray-200 overflow-hidden bg-white mb-4 relative"
              ...
              >
                <iframe
                  ...
                  style={{
                    ...
                    transform: `scale(${typeof window !== "undefined" ? Math.min(1, (window.innerWidth - 64) / 1280) : 0.5})`,
                  }}
                />
              </div>
